...
[Github Issues](https://github.com/linux-system-roles/nbde_server/issues).
Issues labeled with
[**help wanted**](https://github.com/linux-system-roles/nbde_server/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)
are likely to be suitable for new contributors!

**Code** is managed on [Github](https://github.com/linux-system-roles/nbde_server), using
...
For example, see [meta](https://github.com/linux-system-roles/nbde_server/blob/main/meta/main.yml)
